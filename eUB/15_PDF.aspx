<%@ Page Language="C#" AutoEventWireup="true" CodeFile="15_PDF.aspx.cs" Inherits="ePoll_eUB_15_PDF" %>
...
<script type = "text/javascript">
    ...
    <style>
          .circle { width: 50px;   height: 50px;  border: 1px solid black;    border-radius: 50%;       margin: auto; 
        }    </style>
