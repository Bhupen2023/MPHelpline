...
public partial class ePoll_eUB_PO_ALLVoter : System.Web.UI.Page
...
{ 
    ...
    public DataSet GetALLVoterData()
    {
        ...
        Query = " SELECT   [V_EPICNO]  ,[V_SNO] ,[V_Name] ,[V_Fname]  ,[V_Gender]  ,[V_Age]  FROM [sys_admin].[eVoter_PAN] where [isActive]=1  order by V_SNO ";
