<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PO_ALLVoter.aspx.cs" Inherits="ePoll_eUB_PO_ALLVoter" %>
...
M.P. State Election Commission
 ...
 <asp:Button runat="server" ID="btn_Login" CssClass="lgnbtn" OnClick="btBack_Click" Text="Back" />
              ...
              <asp:Panel ID="pnlgrdvw"  style="width:100%; height:500px; " ScrollBars="Auto"  runat="server" >	  
...
<ItemTemplate>
   ...
   <asp:Label ID="lblV_Name" runat="server" style="text-align: left !important; float:left;   font-size:medium; " Text='<%#Eval ("V_Name")%>'></asp:Label>
        ...
        <asp:TemplateField HeaderText="पिता का नाम " ItemStyle-Width="150">
            <ItemTemplate>
                ...
                <asp:Label ID="lblV_Fname" runat="server" style="text-align: left !important; float:left;   font-size:medium; " Text='<%#Eval ("V_Fname")%>'></asp:Label>
        ...
        <asp:TemplateField HeaderText="लिंग" ItemStyle-Width="100">
            <ItemTemplate>
               <asp:Label ID="lblV_Gender" runat="server" style="text-align: left !important; float:left;   font-size:medium; " Text='<%#Eval ("V_Gender")%>'></asp:Label>
        ...
        <asp:TemplateField HeaderText="आयु" ItemStyle-Width="100">
            <ItemTemplate>
               <asp:Label ID="lblV_Age" runat="server" style="text-align: left !important; float:left;   font-size:medium; " Text='<%#Eval ("V_Age")%>'></asp:Label>
