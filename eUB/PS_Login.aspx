<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PS_Login.aspx.cs" Inherits="ePoll_eUB_PS_Login" %>
...
M.P. State Election Commission
            ...
            <asp:Button runat="server" ID="btn_Login" OnClick="btLogin_Click" CssClass="lgnbtn" Text="Login" />
